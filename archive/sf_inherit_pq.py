...
With Quenching Probability implementation of quenching.
...
def _StarformingEvol(ancestor, descendant, succession=None, will=None, sfr_prop=None, evol_prop=None, t_q=None, z_q=None, lineage=None): 
    ...
    if massevol_prop['name'] == 'integrated':   # integrated stellar mass 
        ...
        descendant.mass[succession[sf_ancestors]], descendant.sfr[succession[sf_ancestors]] = \
                M_integrate(
                        logSFR_M_t,                         # logSFR(M*,t) function 
...
def logSFR_M_t(logmass, t_input, t_init=None, t_q=None, z_q=None, M_q=None, dutycycle_prop=None, tau_prop=None, sfms_prop=None): 
...
def M_integrate(logsfr, logmass0, t0, tf, massevol_prop=None, kwargs_sfr=None):
