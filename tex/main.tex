...
\author{ChangHoon~Hahn\altaffilmark{1 $\ast$}, 
Jeremy L.~Tinker\altaffilmark{1}, 
Andrew Wetzel\altaffilmark{2,3,4}$\dagger$}\thanks{$\ast$ e-mail: changhoon.hahn@nyu.edu}\thanks{$\dagger$ Caltech-Carnegie Fellow}
%\altaffiliation{Caltech-Carnegie Fellow}}
